Feature: Accommodation Reserve
  ...
  Scenario Outline: Validate the customer information form
    ...
    Then I validate the booking summary start date "<Check-in>" and end date "<Check-Out>"
  Examples:
    |  | Check-in        | Check-Out       |
    |  | Thu Mar 14 2024 | Thu Mar 28 2024 |

  @paymentMethod @Regression
  Scenario: Validate the payment method and get the final price of the reservation
