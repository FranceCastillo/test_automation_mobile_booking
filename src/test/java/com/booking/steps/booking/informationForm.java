...
public class informationForm {
    ...
    @Then("I validate the booking summary start date {string} and end date {string}")
    public void i_validate_the_booking_summary_with_the_total_price_start_date_and_end_date(String CheckIn, String CheckOut) {
